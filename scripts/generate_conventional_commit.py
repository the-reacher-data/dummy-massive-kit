...
def generate_conventional_commit(branch_name: str, pr_title: str | None = None) -> str:
    """
    ...
    if pr_title and not re.match(
        r"^(feat|fix|docs|style|refactor|perf|test|chore|ci)(\(.+\))?:", pr_title
    ):
